...
begin
  ...
  for i:=1 to n do
    for j:=1 to m do
      if i mod 200 = 0 then field[i,j] := 1;
  for i:=1 to n do
    for j:=1 to m do
      if j mod 200 = 0 then field[i,j] := 1;

  for i:=1 to n do
    for j:=1 to m do
      if (i mod 200 = 50) and (j mod 200 = 50) then
        tree(i,j,random(4));

  for i:=1 to n do
    for j:=1 to m do
      if i mod 100 = 0 then field[i,j] := 0;
  for i:=1 to n do
    for j:=1 to m do
      if j mod 100 = 0 then field[i,j] := 0;

  writeln(n*2,' ',m*2);
  for i:=1 to n*2 do
    begin
      for j:=1 to m*2 do write(field[(i+1)div 2,(j+1) div 2]);
      writeln;
    end;
end.